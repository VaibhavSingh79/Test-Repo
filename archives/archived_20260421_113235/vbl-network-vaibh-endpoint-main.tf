# Generated Terraform for VPC: vbl-network-vaibh-endpoint-main
# Account: Network | OU: Infrastructure

resource "aws_vpc" "vbl_network_vaibh_endpoint_main" {
  cidr_block           = "10.0.0.0/21"
  enable_dns_support   = true
  enable_dns_hostnames = true
  
  tags = {
    Name        = "vbl-network-vaibh-endpoint-main"
    Environment = "POC"
    AccountName = "Network"
  }
}
...
resource "aws_subnet" "vbl_ue2_network_db_A" {
  vpc_id     = aws_vpc.vbl_network_vaibh_endpoint_main.id
